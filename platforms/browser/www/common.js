(self["webpackChunke_commerceApp"] = self["webpackChunke_commerceApp"] || []).push([["common"],{
...
let CartModalPage = class CartModalPage {
    constructor(navParams, cartService, modalController) {
...
let CartService = class CartService {
    ...
    //     this.firestore.collection('Carts').doc(this.cartKey).valueChanges().subscribe((result:any)=>{
    ...
    //   }
    //   else{
    //     const fbDocument = await this.firestore.collection('Carts').add({
...
FavouriteService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
